...
$('#registration').click(function() {
    ...
    if (registration.prop("checked")) {
        registration.removeProp("checked");
    } else {
        registration.prop("checked","checked");
    }
});
...
//   newDiv.innerHTML = 'Пустое поле!';
//    var p = document.querySelectorAll('#username');
...
function showErrorEmailTwo(){
    $('body').append('<div class="modal ErrorEmail">Ваш email не корректен!</div>');
}
...
function showErrorRepeatPasswordEmpty(){
    $('body').append('<div class="modal ErrorRepeatPassword">Пустое поле</div>');
}
